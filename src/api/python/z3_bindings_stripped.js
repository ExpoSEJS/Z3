...
GeneratedBindings['Z3_param_descrs_get_documentation'] = [ CString, [ ContextObj, ParamDescrs, Symbol]];
...
GeneratedBindings['Z3_mk_seq_sort'] = [ Sort, [ ContextObj, Sort]];
GeneratedBindings['Z3_is_seq_sort'] = [ CInt, [ ContextObj, Sort]];
GeneratedBindings['Z3_mk_re_sort'] = [ Sort, [ ContextObj, Sort]];
GeneratedBindings['Z3_is_re_sort'] = [ CInt, [ ContextObj, Sort]];
GeneratedBindings['Z3_mk_string_sort'] = [ Sort, [ ContextObj]];
GeneratedBindings['Z3_is_string_sort'] = [ CInt, [ ContextObj, Sort]];
GeneratedBindings['Z3_mk_string'] = [ Ast, [ ContextObj, CString]];
GeneratedBindings['Z3_is_string'] = [ CInt, [ ContextObj, Ast]];
GeneratedBindings['Z3_get_string'] = [ CString, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_seq_empty'] = [ Ast, [ ContextObj, Sort]];
GeneratedBindings['Z3_mk_seq_unit'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_seq_concat'] = [ Ast, [ ContextObj, CUInt, AstArray]];
GeneratedBindings['Z3_mk_seq_prefix'] = [ Ast, [ ContextObj, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_suffix'] = [ Ast, [ ContextObj, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_contains'] = [ Ast, [ ContextObj, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_extract'] = [ Ast, [ ContextObj, Ast, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_replace'] = [ Ast, [ ContextObj, Ast, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_at'] = [ Ast, [ ContextObj, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_length'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_seq_index'] = [ Ast, [ ContextObj, Ast, Ast, Ast]];
GeneratedBindings['Z3_mk_seq_to_re'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_seq_in_re'] = [ Ast, [ ContextObj, Ast, Ast]];
GeneratedBindings['Z3_mk_re_plus'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_re_star'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_re_option'] = [ Ast, [ ContextObj, Ast]];
GeneratedBindings['Z3_mk_re_union'] = [ Ast, [ ContextObj, CUInt, AstArray]];
GeneratedBindings['Z3_mk_re_concat'] = [ Ast, [ ContextObj, CUInt, AstArray]];
...
GeneratedBindings['Z3_get_estimated_alloc_size'] = [ CULong, [ ]];
